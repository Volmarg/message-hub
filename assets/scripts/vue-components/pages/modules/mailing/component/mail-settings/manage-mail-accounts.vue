                ...
                <section v-if="!(mailAccountDto.name === defaultAccountName && isDemo)">
                  ...
                  >
                    ...
                    <material-input-field
                        :display-block="true"
                        :label="hostTranslatedString"
                        :value="mailAccountDto.host"
                        :ref="'materialEditModalHostInput_' + mailAccountDto.id"
                        :error-message="hostErrorMessage"
                    />
...
export default {
  ...
  computed: {
    ...
    hostTranslatedString(){
      return translationService.getTranslationForString('pages.mailing.manageMailAccounts.table.headers.host');
    },
  ...
  methods: {
    ...
    async onMaterialEditModalConfirmButtonClick(mailAccountDtoId){
      ...
      let host     = this.$refs['materialEditModalHostInput_'   + mailAccountDtoId].textFieldValue;
      ...
      this.hostErrorMessage     = baseApiResponseDto.invalidFields.host ?? "";
      ...
      // whole data
      currentlyProcessedMailAccountDto.host     = host;
      ...
      currentlyProcessedMailAccountDtoForTable.host   = host;
    ...
    async sendMailAccountUpdateRequest(csrfToken, mailAccountDtoId){
      let ajaxData = {
        host     : this.$refs['materialEditModalHostInput_'     + mailAccountDtoId].textFieldValue,
