...
use App\DTO\API\Internal\Discord\MessageInsertResponseDto;
...
class DiscordExternalApiAction extends AbstractController
{
    ...
    public function insertDiscordMessage(Request $request): JsonResponse
    {
        try{
            ...
            $apiResponseDto = new MessageInsertResponseDto();
            $apiResponseDto->prefillBaseFieldsForSuccessResponse();
            ...
            if( JSON_ERROR_NONE !== json_last_error() ){
                ...
                $apiResponseDto->prefillBaseFieldsForBadRequestResponse();
                $apiResponseDto->setMessage($message);

                return $apiResponseDto->toJsonResponse();
            }
            ...
            $apiResponseDto->setMessage($message);
            $apiResponseDto->setId($discordMessage->getId());
            ...
            $responseDto = MessageInsertResponseDto::buildBadRequestErrorResponse();
            ...
            $responseDto = MessageInsertResponseDto::buildInternalServerErrorResponse();
            $responseDto->setMessage($message);
