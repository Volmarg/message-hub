...
{
    // just random high number and anybody will be dead in 100 years anyway, that's enough time to block the mail
    ...
    /**
     * Return payload array or NULL if something is wrong with the token
     *
     * @param string $token
     *
     * @return array|null
