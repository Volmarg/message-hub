...
class MailController extends AbstractController
{
    ...
    /**
     * Will send single email via {@see NotifierInterface}, which means it adds some extra styling etc.
     *
     * @param Mail     $mail
     ...
     * @throws OptimisticLockException
     */
    public function sendSingleEmailViaNotifier(Mail $mail, Notifier $notifier, bool $createOrUpdate = true)
    {
     ...
     */
    public function sendSingleEmailViaMailer(Mail $mail, Mailer $mailer, MailAccount $mailAccount, bool $createOrUpdate = true): void
    {
        $txt   = strip_tags($mail->getBody());
        $email = (new Email())
            ->from($mailAccount->buildFromEmail())
