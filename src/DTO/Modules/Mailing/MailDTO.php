...
class MailDTO extends AbstractDTO
{
    ...
    public static function fromJson(string $json): MailDTO
    {
        ...
        $isTrackOpenState = self::checkAndGetKey($dataArray, self::KEY_TRACK_OPEN_STATE, false);
        $id               = self::checkAndGetKey($dataArray, self::KEY_ID);
        ...
        $dto->setTrackOpenState($isTrackOpenState);
