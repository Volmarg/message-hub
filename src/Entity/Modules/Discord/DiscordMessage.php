...
/**
 * @ORM\Entity(repositoryClass=DiscordMessageRepository::class)
 */
class DiscordMessage implements EntityInterface
{
     ...
     * @ORM\Column(type="text")
     */
    private string $reSendingError;

    /**
     * @ORM\Column(type="text")
     */
    private string $sendToError;
